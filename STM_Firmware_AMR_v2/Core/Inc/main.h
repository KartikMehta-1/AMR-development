...
#define CURR_R_SENSE_Pin GPIO_PIN_1
#define CURR_R_SENSE_GPIO_Port GPIOC
...
#define CURR_L_SENSE_Pin GPIO_PIN_0
#define CURR_L_SENSE_GPIO_Port GPIOB
...
#define DIR_LEFT_Pin GPIO_PIN_4
