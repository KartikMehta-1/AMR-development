...
| Output Torque (70-80% Inom) | 2.15 - 2.46 N·m |
| Est. Current | ~2.5 A |
...
| Networking | 1G Gigabit Ethernet (RJ45) |
| USB | USB 3.0 + USB 2.0 (via dev kit carrier) |
| Camera | 2x MIPI CSI-2 (15-pin) connectors |
...
| Depth Resolution / FPS | e.g., 848x480 up to high fps; 1280x720 typical (confirm) |
